...
public class Drivetrain extends SubsystemBase{
    ...
    public Drivetrain(){
        ...
        rightEncoder.setPositionConversionFactor(Constants.kDistPerRot); // create EncoderDistancePerPulse constant later
        leftEncoder.setPositionConversionFactor(Constants.kDistPerRot); // same thing
